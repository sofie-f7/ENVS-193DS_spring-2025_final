...
In this data set, 0s mean there is nest occupancy and 1s mean there is no nest occupancy. The 1s and 0s are a measure of if the nest is occupied by a bird or not.
...
ggplot(bird_data_clean,
  ...
  geom_line(data = model1_predictions,
            aes(x = edge_distance,
                y = predicted,
                color = season)) +
  scale_color_manual(values = c("2016" = "plum2", "2019" = "lightgreen")) + 
  scale_fill_manual(values = c("2016" = "plum2", "2019" = "lightgreen")) +
  labs(
